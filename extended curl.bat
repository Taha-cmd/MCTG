...
FOR /F "tokens=*" %%g IN ('curl -X POST http://localhost:10001/sessions --header "Content-Type: application/json" -d "{\"Username\":\"altenhof\",\"Password\":\"markus\"}"') do (SET ALTENHOF_TOKEN=%%g)
FOR /F "tokens=*" %%g IN ('curl -X POST http://localhost:10001/sessions --header "Content-Type: application/json" -d "{\"Username\":\"admin\",\"Password\":\"istrator\"}"') do (SET ADMIN_TOKEN=%%g)
echo.

echo token for altenhof:    %ALTENHOF_TOKEN%
echo token for kienboec:	%KIENBOEC_TOKEN%
echo token for admin:		%ADMIN_TOKEN%

echo should fail:
curl -X POST http://localhost:10001/sessions --header "Content-Type: application/json" -d "{\"Username\":\"kienboec\", \"Password\":\"different\"}"
echo.
echo extended test (no password)
curl -X POST http://localhost:10001/sessions --header "Content-Type: application/json" -d "{\"Username\":\"kienboec\"}"
echo.
...
curl -X POST http://localhost:10001/transactions/packages --header "Content-Type: application/json" --header "Authorization: Basic %ALTENHOF_TOKEN%" -d ""
echo.
curl -X POST http://localhost:10001/transactions/packages --header "Content-Type: application/json" --header "Authorization: Basic %ALTENHOF_TOKEN%" -d ""
echo.
...
curl -X PUT http://localhost:10001/deck --header "Content-Type: application/json" --header "Authorization: Basic %KIENBOEC_TOKEN%" -d "[\"845f0dc7-37d0-426e-994e-43fc3ac83c08\", \"99f8f8dc-e25e-4a95-aa2c-782823f36e2a\", \"e85e3976-7c86-4d06-9a80-641c2019a79f\", \"171f6076-4eb5-4a7d-b3f2-2d650cc3d237\"]"
echo.
curl -X GET http://localhost:10001/deck --header "Authorization: Basic %KIENBOEC_TOKEN%"
echo.
curl -X PUT http://localhost:10001/deck --header "Content-Type: application/json" --header "Authorization: Basic %ALTENHOF_TOKEN%" -d "[\"aa9999a0-734c-49c6-8f4a-651864b14e62\", \"d6e9c720-9b5a-40c7-a6b2-bc34752e3463\", \"d60e23cf-2238-4d49-844f-c7589ee5342e\", \"02a9c76e-b17d-427f-9240-2dd49b0d3bfd\"]"
echo.
curl -X GET http://localhost:10001/deck --header "Authorization: Basic %ALTENHOF_TOKEN%"
echo.
echo.
echo should fail and show original from before:
curl -X PUT http://localhost:10001/deck --header "Content-Type: application/json" --header "Authorization: Basic %ALTENHOF_TOKEN%" -d "[\"845f0dc7-37d0-426e-994e-43fc3ac83c08\", \"99f8f8dc-e25e-4a95-aa2c-782823f36e2a\", \"e85e3976-7c86-4d06-9a80-641c2019a79f\", \"171f6076-4eb5-4a7d-b3f2-2d650cc3d237\"]"
echo.
curl -X GET http://localhost:10001/deck --header "Authorization: Basic %ALTENHOF_TOKEN%"
echo.
echo.
echo should fail ... only 3 cards set
curl -X PUT http://localhost:10001/deck --header "Content-Type: application/json" --header "Authorization: Basic %ALTENHOF_TOKEN%" -d "[\"aa9999a0-734c-49c6-8f4a-651864b14e62\", \"d6e9c720-9b5a-40c7-a6b2-bc34752e3463\", \"d60e23cf-2238-4d49-844f-c7589ee5342e\"]"
echo.
...
curl -X GET http://localhost:10001/tradings --header "Authorization: Basic %KIENBOEC_TOKEN%"
echo.
curl -X GET http://localhost:10001/tradings --header "Authorization: Basic %ALTENHOF_TOKEN%"
echo.
echo delete trading deals
curl -X DELETE http://localhost:10001/tradings/6cd85277-4590-49d4-b0cf-ba0a921faad0 --header "Authorization: Basic %KIENBOEC_TOKEN%"
echo.
echo.
...
curl -X POST http://localhost:10001/tradings/6cd85277-4590-49d4-b0cf-ba0a921faad0 --header "Content-Type: application/json" --header "Authorization: Basic %KIENBOEC_TOKEN%" -d "\"4ec8b269-0dfa-4f97-809a-2c63fe2a0025\""
echo.
echo try to trade 
echo.
...
curl -X DELETE http://localhost:10001/sessions  --header "Authorization: Basic %KIENBOEC_TOKEN%"
echo.
curl -X DELETE http://localhost:10001/sessions  --header "Authorization: Basic %ALTENHOF_TOKEN%"
echo.
curl -X DELETE http://localhost:10001/sessions  --header "Authorization: Basic %ADMIN_TOKEN%"
